...
const ProductList = () => {
  ...
  const columns = [
    ...
    { key: 'installment_price', label: 'Installment Price', 
      render: (value) => value ? `$${parseFloat(value).toFixed(2)}` : 'N/A' },
          ...
          <div className="bg-gray-50 p-4 rounded-lg">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <Input
                ...
                onChange={(e) => setFormData(prev => ({ ...prev, in_stock: parseInt(e.target.value) }))}
                required
                className="border-gray-300 focus:border-blue-500 focus:ring-blue-500"
              />
              <Input
          ...
          <div className="bg-gray-50 p-4 rounded-lg">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <Input
                ...
                onChange={(e) => setFormData(prev => ({ ...prev, installment_price: e.target.value }))}
                className="border-gray-300 focus:border-blue-500 focus:ring-blue-500"
              />
              <Input
                label="Unit Price"
          ...
          <div className="bg-gray-50 p-4 rounded-lg">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <Input
                ...
                onChange={(e) => setFormData(prev => ({ ...prev, incentive: e.target.value }))}
                className="border-gray-300 focus:border-blue-500 focus:ring-blue-500"
              />
            </div>
          </div>
