...
const TransactionsPage = () => {
  const transactions = [
    { id: 1, customer: 'John Doe', amount: 129.99, status: 'Completed', date: '2024-01-15 14:30', method: 'Credit Card' },
    { id: 2, customer: 'Jane Smith', amount: 89.98, status: 'Pending', date: '2024-01-15 15:45', method: 'Cash' },
    { id: 3, customer: 'Mike Johnson', amount: 249.97, status: 'Completed', date: '2024-01-15 16:20', method: 'Debit Card' },
    { id: 4, customer: 'Sarah Wilson', amount: 79.99, status: 'Failed', date: '2024-01-15 17:10', method: 'Credit Card' },
    { id: 5, customer: 'Tom Brown', amount: 159.98, status: 'Completed', date: '2024-01-15 18:30', method: 'Cash' },
  ];
