...
const InstallmentsPage = () => {
  ...
  console.log("🚀 ~ InstallmentsPage ~ account:", account);
  ...
  const columns4 = [
    { key: "sr", label: "Sr" },
    { key: "rece", label: "Install Date", render: (v) => getFormattedDate(v) },
  ...
  if (account_id) {
    ...
    return (
      <div className="container mx-auto px-4 py-6">
        ...
        {/* Customer Information - Small Cards */}
            ...
            <div className="bg-white p-4 rounded-lg border border-gray-100 shadow-sm">
              ...
              <p className="text-lg font-bold text-gray-900">
                {formatCurrency
                  ...
                  : account.process.product?.cash_price}
              </p>
            </div>
            ...
            <div className="bg-white p-4 rounded-lg border border-gray-100 shadow-sm">
              ...
              <p className="text-lg font-bold text-gray-900">
                {formatCurrency
                  ...
                  : account.process.product?.installment_price}
              </p>
            </div>
            ...
            <div className="bg-white p-4 rounded-lg border border-gray-100 shadow-sm">
              ...
              <p className="text-lg font-bold text-gray-900">
                {formatCurrency
                  ...
                  : account.process.product?.monthly_installment}
              </p>
            </div>
            ...
            <div className="bg-white p-4 rounded-lg border border-gray-100 shadow-sm">
              ...
              <p className="text-lg font-bold text-gray-900">
                {formatCurrency
                  ...
                  : account.process.product?.advance}
              </p>
            </div>
